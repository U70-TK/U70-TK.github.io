    ...
    <div>
        ...
        >
            ...
            <Grid
                ...
                {/* Social buttons: smaller on mobile, wrap nicely */}
                <Box
                    sx={{
                    display: "flex",
                    flexWrap: "wrap",
                ...
                >
                    ...
                    {
                        label: "Email",
                        // (Optional) you probably want uwaterloo.ca instead of uwaterloo.com
            ...
            <Box sx={{ display: "flex", flexDirection: "column", textAlign: "start", gap: 2.25 }}>
                {[
                {
                    date: "Sep 4th, 2025",
